...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('https://www.facebook.com/profile.php?id=100000521779367')
     os.system('https://www.facebook.com/profile.php?id=100000521779367')
     exit()
    if inpp == "0":
     exit('Exit!')
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.ARIYAN','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.ARIYAN','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.ARIYAN', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/ARIYAN-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mARIYAN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ARIYAN-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mARIYAN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/ARIYAN-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
